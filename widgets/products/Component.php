...
class Component extends Base {
	...
	public function get_title() {
		return __( 'Products', STAX_WOO_DOMAIN );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', STAX_WOO_DOMAIN ),
			]
		);
		...
		$this->add_responsive_control(
			'columns',
			[
				'label'               => __( 'Columns', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'paginate',
			[
				'label'   => __( 'Pagination', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'allow_order',
			[
				'label'     => __( 'Allow Order', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'paginate' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'raw'             => __( 'Ordering is not available if this widget is placed in your front page. Visible on frontend only.', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'show_result_count',
			[
				'label'     => __( 'Show Result Count', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => [
					'paginate' => 'yes',
		...
		$this->start_controls_section(
			'section_query',
			[
				'label' => __( 'Query', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'query_post_type',
			[
				'label'   => __( 'Source', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'query_offset',
			[
				'label'   => __( 'Offset', STAX_WOO_DOMAIN ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'max'     => 100,
				'step'    => 1,
		...
		$this->add_control(
			'query_orderby',
			[
				'label'   => __( 'Order By', STAX_WOO_DOMAIN ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'date',
				'options' => [
					'date'       => __( 'Date', STAX_WOO_DOMAIN ),
					'title'      => __( 'Title', STAX_WOO_DOMAIN ),
					'price'      => __( 'Price', STAX_WOO_DOMAIN ),
					'popularity' => __( 'Popularity', STAX_WOO_DOMAIN ),
					'rating'     => __( 'Rating', STAX_WOO_DOMAIN ),
					'rand'       => __( 'Random', STAX_WOO_DOMAIN ),
					'menu_order' => __( 'Menu Order', STAX_WOO_DOMAIN ),
				],
			]
		);
		...
		$this->add_control(
			'query_order',
			[
				'label'   => __( 'Order', STAX_WOO_DOMAIN ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'desc',
				'options' => [
					'asc'  => __( 'ASC', STAX_WOO_DOMAIN ),
					'desc' => __( 'DESC', STAX_WOO_DOMAIN )
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Products', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			...
			[
				'type'            => Controls_Manager::RAW_HTML,
				'raw'             => __( 'The style of this widget is often affected by your theme and plugins. If you experience any such issue, try to switch to a basic theme and deactivate related plugins.', STAX_WOO_DOMAIN ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
			]
		);
		...
		$this->add_responsive_control(
			'column_gap',
			[
				'label'          => __( 'Columns Gap', STAX_WOO_DOMAIN ),
		...
		$this->add_responsive_control(
			'row_gap',
			[
				'label'          => __( 'Rows Gap', STAX_WOO_DOMAIN ),
				'type'           => Controls_Manager::SLIDER,
				'default'        => [
					'size' => 40,
				],
		...
		$this->add_responsive_control(
			'align',
			[
				'label'        => __( 'Alignment', STAX_WOO_DOMAIN ),
				'type'         => Controls_Manager::CHOOSE,
				'options'      => [
					'left'   => [
						'title' => __( 'Left', STAX_WOO_DOMAIN ),
						'icon'  => 'eicon-text-align-left',
					],
					'center' => [
						'title' => __( 'Center', STAX_WOO_DOMAIN ),
						'icon'  => 'eicon-text-align-center',
					],
					'right'  => [
						'title' => __( 'Right', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			'heading_image_style',
			[
				'label'     => __( 'Image', STAX_WOO_DOMAIN ),
		...
		$this->add_responsive_control(
			'image_border_radius',
			[
				'label'      => __( 'Border Radius', STAX_WOO_DOMAIN ),
		...
		$this->add_responsive_control(
			'image_spacing',
			[
				'label'      => __( 'Spacing', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
		...
		$this->add_control(
			'heading_title_style',
			[
				'label'     => __( 'Title', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label'     => __( 'Color', STAX_WOO_DOMAIN ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Rating', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'star_color',
			[
				'label'     => __( 'Star Color', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'empty_star_color',
			[
				'label'     => __( 'Empty Star Color', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'star_size',
			[
				'label'     => __( 'Star Size', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => [
					'unit' => 'em',
				],
		...
		$this->add_control(
			'heading_price_style',
			[
				'label'     => __( 'Price', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'price_margin',
			[
				'label'      => __( 'Margin', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Regular Price', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Button', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'button_show',
			[
				'label'        => __( 'Show', STAX_WOO_DOMAIN ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', STAX_WOO_DOMAIN ),
				'label_off'    => __( 'Hide', STAX_WOO_DOMAIN ),
				'return_value' => 'yes',
				'default'      => 'yes',
			]
		);
		...
		$this->add_control(
			'button_hidden_style',
			[
				'label'     => __( 'Button Hide', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HIDDEN,
				'default'   => '1',
				'selectors' => [
		...
		$this->start_controls_tab(
			'tab_button_normal',
			[
				'label' => __( 'Normal', STAX_WOO_DOMAIN ),
			]
		);
		...
		$this->add_control(
			'button_text_color',
			[
				'label'     => __( 'Text Color', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Background Color', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_border_color',
			[
				'label'     => __( 'Border Color', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_tab(
			'tab_button_hover',
			[
				'label' => __( 'Hover', STAX_WOO_DOMAIN ),
			]
		);
		...
		$this->add_control(
			'button_text_padding',
			[
				'label'      => __( 'Text Padding', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'View Cart', STAX_WOO_DOMAIN ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'box_border_width',
			[
				'label'      => __( 'Border Width', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_responsive_control(
			'box_padding',
			[
				'label'      => __( 'Padding', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Border', STAX_WOO_DOMAIN ),
				'type'         => Controls_Manager::SWITCHER,
				'label_off'    => __( 'Hide', STAX_WOO_DOMAIN ),
				'label_on'     => __( 'Show', STAX_WOO_DOMAIN ),
				'default'      => 'yes',
		...
		$this->start_controls_tab( 'pagination_style_active',
			[
				'label' => __( 'Active', STAX_WOO_DOMAIN ),
			]
		);
		...
		$this->start_controls_section(
			'sale_flash_style',
			[
				'label' => __( 'Sale Flash', STAX_WOO_DOMAIN ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'onsale_width',
			[
				'label'      => __( 'Width', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
		...
		$this->add_control(
			'onsale_height',
			[
				'label'      => __( 'Height', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'                => __( 'Position', STAX_WOO_DOMAIN ),
				'type'                 => Controls_Manager::CHOOSE,
				'label_block'          => false,
				'options'              => [
					'left'  => [
		...
		$this->add_control(
			'onsale_distance',
			[
				'label'      => __( 'Distance', STAX_WOO_DOMAIN ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'range'      => [
					'px' => [
