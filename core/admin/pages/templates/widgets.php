...
<div class="ste-mt-5">
	<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST">
		<div class="ste-flex ste-flex-wrap ste--mx-2">
			<?php foreach ( $widgets as $key => $widget ) : ?>
				<div class="ste-my-2 ste-w-full md:ste-w-1/2 lg:ste-w-1/3 xl:ste-w-1/4">
					<div class="ste-mx-2">
						<label for="module-label-<?php echo esc_attr( $key ); ?>"
							...
							<div class="ste-flex ste-justify-between ste-items-center">
								<span class="ste-font-medium ste-text-gray-600 ste-text-sm"><?php echo esc_html( $widget['name'] ); ?></span>
								<div class="ste-relative">
									<input type="checkbox" name="<?php echo esc_attr( $widget['slug'] ); ?>"
										id="module-label-<?php echo esc_attr( $key ); ?>" class="ste-toggle-input" <?php checked( $widget['status'] ); ?>>
		...
		<?php wp_nonce_field( 'stax_woo_widget_activation' ); ?>
        ...
        <div class="ste-mt-5">
			<button type="submit"
				...
				<span class="ste-flex ste-items-center">
					...
					<span class="ste-leading-none ste-font-bold ste-ml-2 ste-uppercase"><?php esc_html_e( 'Save', 'stax-woo-addons-for-elementor' ); ?></span>
				</span>
			</button>
		</div>
	</form>
